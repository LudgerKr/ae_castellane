...
class Paypal_lib{
    ...
    function __construct(){
        ...
        $this->add_field('quantité', '1');
        $this->button('Payez maintenant !');
    }
    ...
    function paypal_auto_form(){
        ...
        $this->button('Cliquez ici si vous n\'êtes pas automatiquement redirigé ...');

        echo '<html>' . "\n";
        echo '<head><link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous"><title>Traitement du paiement ...</title></head>' . "\n";
        echo '<body style="text-align:center;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
        echo '<p style="text-align:center;" class="mt-5">Veuillez patienter, votre commande est en cours de traitement et vous serez redirigé vers le site Web paypal.</p><br><div class="spinner-grow text-muted"></div><div class="spinner-grow text-muted"></div><div class="spinner-grow text-muted"></div>' . "\n";
