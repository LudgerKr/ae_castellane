...
<ul class="nav container mt-5 nav-tabs">
	...
	<li class="nav-item">
	  <a class="nav-link active" href="<?= site_url('admin/vehicule') ?>">Vehicules</a>
	</li>
	<li class="nav-item">
...
<div class="container mt-5">
		...
		<div class="col-sm-6">
			...
			<table class="table table-striped table-sm" id="dataTable">
				<thead>
			  	...
			  	<tbody>
					<?php 
	  					foreach ($get_vehicles as $row): 
   							if($row['status'] == 'Occupée'): 
					?>
				  		<tr class="text-center">
	...
	<div class="col-sm-6 mt-5">
			<h3> Liste des voitures Détruite </h3><hr>
		    <table class="table table-striped table-sm" id="dataTable">
			  <thead>
				<tr class="text-center">
				  <th>#</th>
			  ...
			  <tbody>
				<?php foreach ($get_vehicles as $row): if($row['status'] == 'Détruite'): ?>
				  <tr class="text-center">
					<td><?= $row['idvehicles'] ?></td>
					<td><?= $row['brand'] ?></td>
					<td><?= $row['mileage'] ?></td>
