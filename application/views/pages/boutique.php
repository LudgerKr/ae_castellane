<div class="article-list">
  <?= form_open('user/signin') ?>    
    <div class="container">
      <div class="intro animated bounceIn">
      ...
      <div class="row articles">
        <?php 
		 ...
		 ?>
          <div class="col-sm-6 col-md-4 item animated zoomInDown delay-1s"><a><h1 class="card-title pricing-card-title"><?= $boutique['price'] ?><small class="text-muted">/ EUR </small></h1></a>
