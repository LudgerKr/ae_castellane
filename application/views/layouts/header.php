	...
	<head>
		...
		<script>
		  document.addEventListener('DOMContentLoaded', function() {
			...
			<script async src="https://www.googletagmanager.com/gtag/js?id=UA-138686468-1"></script>
			<script>
			  window.dataLayer = window.dataLayer || [];
			  function gtag(){dataLayer.push(arguments);}
			  gtag('js', new Date());

			  gtag('config', 'UA-138686468-1');
			</script>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navcol-1">
					<ul class="nav navbar-nav mr-auto">
						...
						<li class="nav-item animated lightSpeedIn" role="presentation"><a class="nav-link" href="<?= site_url('presente'); ?>">Présentation</a></li>
						<li class="nav-item animated lightSpeedIn delay-1s" role="presentation"><a class="nav-link" href="<?= site_url('boutique'); ?>">Boutique</a></li>
						<li class="nav-item animated lightSpeedIn delay-2s" role="presentation"><a class="nav-link" href="<?= site_url('forum'); ?>">Forum</a></li>
						<li class="nav-item animated lightSpeedIn delay-3s" role="presentation"><a class="nav-link" onclick="document.getElementById('contact').style.display='block'">Contact</a></li>
					</ul>
