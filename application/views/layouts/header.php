...
<head>
  ...
  <link rel="icon" type="image/png" href="application/assets/picture/logoCastellane.png" alt="Erreur">
  ...
  <header class="sticky-top">
    <div class="sticky-top py-1 d-flex flex-column flex-md-row align-items-center p-3 px-md-4 bg-white border-bottom shadow-sm">
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
            <div class="container"><a class="navbar-brand" href="<?= site_url("accueil"); ?>">Castellane-Auto</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse"
                    id="navcol-1">
                    <ul class="nav navbar-nav mr-auto">
                        <li class="nav-item nav-link" role="presentation"><b><i>Projet BTS SIO SLAM</b></i></li>
                ...
                <?php 
                    ...
                    {echo'
                        <div class="form-inline mt-2 mt-md-0 ">
                            <a class="btn btn-success action-button m-2 ml-5" href="'.site_url('user/quizz').'">Quizz</a>
